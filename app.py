...
def token_obrigatorio(f):
    ...
    def decorated(*args, **kwargs):
        ...
        if not token:
            return jsonify({'mensagem': 'Token de autenticação precisa ser incluído nessa requisição!'})  # noqa: E501
        try:
...
def login():
    ...
    if not dados_autenticacao or not dados_autenticacao.username or not dados_autenticacao.password:  # noqa: E501
        return make_response('Login inválido', 401, {'WWW-Authenticate': 'Basic realm="Login obrigatório!"'})  # noqa: E501
